...
A partir de esta imagen corregida y luego de aplicar la antitransformada a la imagen original, se obtiene que el problema de bandeado fue corregido exitosamente. En la figura \ref{SRTMSinFourierCorrected} se puede observar el bandeado ya corregido.
