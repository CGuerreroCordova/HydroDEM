...
Como primer paso de este proceso se aplica un filtro cuadrático de suavizado de la imagen. El filtro cuadrático que se usa es debido a las características del terreno. Este filtro nos da como resultado un DEM en donde se han planchado todas las irregularidades del terreno y dejando a las ondulaciones más relevantes. A modo de ilustrar el efecto de este filtro sobre el terreno se puede ver la figura \ref{filtroCuadratico}:
...
A partir de la diferencia entre el DEM SRTM y el suavizado cuadrático obtenido en el paso anterior se puede obtener una imagen que será llamada "`Resaltado"', Figura \ref{demResaltado}.
...
Aplicando una condición sobre los valores del DEM Resaltado, se puede obtener una máscara para diferentes alturas, en particular se eligen los valores que superen la altura de 1.5 metros. Figura \ref{maskTrees}
